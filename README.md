...
Примечание:
В UI тестах увеличен тайм-аут до 15 секунд. Это связанно с тем, что при выполнении теста эпизодически появляется CAPTCHA, которую, как я поняла обойти нельзя. Поэтому при выполнении UI тестов время от времени нужно вручную потдверждать КиноПоиску, что я не робот, что бы тест не упал.

Шаги
Склонировать проект 'git clone https://github.com/AlbertZam354/Final_Project
